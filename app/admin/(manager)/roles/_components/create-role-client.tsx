...
import { createRoleAction } from "../_actions/create";
...
export default function CreateRoleClient() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setLoading(true);
    try {
      await createRoleAction({ name: trimmed, permissions });
      ...
      <div className="lg:col-span-1">
        <div className="bg-white rounded shadow p-6 space-y-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button type="button" variant="outline" className="cursor-pointer" onClick={() => router.push("/admin/roles")}>
              Hủy
            </Button>
          </div>
        </div>
